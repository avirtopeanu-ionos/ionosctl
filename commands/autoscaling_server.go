...
func autoscalingServer() *core.Command {
	...
	autoscalingServerCmd := &core.Command{
		Command: &cobra.Command{
			Use:              "server",
			Aliases:          []string{"svr"},
			Short:            "Autoscaling Server Operations",
			Long:             "The sub-commands of `ionosctl autoscaling server` allow you to list, get Servers from an Autoscaling Group.",
	...
	*/
	list := core.NewCommand(ctx, autoscalingServerCmd, core.CommandBuilder{
		...
		Verb:       "list",
		Aliases:    []string{"l", "ls"},
		ShortDesc:  "List Servers from an Autoscaling Group",
		LongDesc:   "Use this command to retrieve a complete list of Servers from a specified Autoscaling Group provisioned under your account.\n\nRequired values to run command:\n\n* Autoscaling Group Id",
