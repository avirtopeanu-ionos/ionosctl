...
func RunAutoscalingTemplateList(c *core.CommandConfig) error {
	...
	return c.Printer.Print(getAutoscalingTemplatePrint(nil, c, getAutoscalingTemplates(autoscalingTemplates)))
}
...
func RunAutoscalingTemplateGet(c *core.CommandConfig) error {
	...
	return c.Printer.Print(getAutoscalingTemplatePrint(nil, c, []sdkAutoscaling.Template{*autoTemplate}))
}
...
func RunAutoscalingTemplateCreate(c *core.CommandConfig) error {
	...
	return c.Printer.Print(getAutoscalingTemplatePrint(resp, c, []sdkAutoscaling.Template{*dc}))
}
...
func RunAutoscalingTemplateDelete(c *core.CommandConfig) error {
	...
	return c.Printer.Print(getAutoscalingTemplatePrint(resp, c, nil))
}
...
func getAutoscalingTemplatePrint(resp *sdkAutoscaling.Response, c *core.CommandConfig, dcs []sdkAutoscaling.Template) printer.Result {
	r := printer.Result{}
	if c != nil {
		if resp != nil {
