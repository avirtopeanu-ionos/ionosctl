...
const (
	...
	ArgLatest                  = "latest"
	ArgMethod                  = "method"
	ArgMaxReplicaCount         = "max-replica-count"
	ArgMinReplicaCount         = "min-replica-count"
	ArgTargetReplicaCount      = "target-replica-count"
	ArgTargetReplicaCountShort = "t"
	ArgMetric                  = "metric"
	ArgMetricShort             = "m"
	ArgRange                   = "range"
	ArgRangeShort              = "r"
	ArgUnit                    = "unit"
	ArgScaleOutThreshold       = "scale-out-threshold"
	ArgScaleInThreshold        = "scale-in-threshold"
	ArgScaleInAmount           = "scale-in-amount"
	ArgScaleInAmountType       = "scale-in-amount-type"
	ArgScaleInCoolDownPeriod   = "scale-in-cooldown"
...
const (
	...
	RequiredFlagActionId       = "The unique Action Id " + RequiredFlag
)
